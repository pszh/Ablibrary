...
import com.pszh.ablibrary.fragment.AbAlertDialogFragment;
import com.pszh.ablibrary.fragment.AbDialogFragment;
import com.pszh.ablibrary.fragment.AbLoadDialogFragment;
import com.pszh.ablibrary.fragment.AbProgressDialogFragment;
import com.pszh.ablibrary.fragment.AbProgressDialogFragment2;
import com.pszh.ablibrary.fragment.AbRefreshDialogFragment;
import com.pszh.ablibrary.fragment.AbSampleDialogFragment;
...
public class AbDialogUtil {
	 ...
	 * @param message the message
	 */
	public static AbProgressDialogFragment2 showProgressDialog2(Context context, int indeterminateDrawable, String message) {
		FragmentActivity activity = (FragmentActivity)context;
		AbProgressDialogFragment2 newFragment = AbProgressDialogFragment2.newInstance(indeterminateDrawable,message);
		FragmentTransaction ft = activity.getFragmentManager().beginTransaction();
        // 指定一个系统转场动画   
        ft.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);  
		newFragment.show(ft, mDialogTag);
